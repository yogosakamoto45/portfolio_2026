  ...
  const works = [
    {
      ...
      title: "既存SaaSを進化させた新プロダクトの開発",
      bg: "背景・目的",
      bgTxt: [
        "10年程前に開発された既存SaaSの課題を踏まえ、現代の利用環境やユーザーニーズに対応した新たなSaaSプロダクトを開発。",
        "旧製品と並行して展開することを前提に、これまでの機能や利用実態を踏まえながら、UI/UXの刷新や新機能の追加を行いました。",
      ],
      approach: [
        { th: "レガシーUIの刷新", td: "旧製品の使い勝手や課題を見直し、現在のWebサービスの水準に合わせたUI/UXを再設計。より直感的で使いやすい操作性を目指しました。" },
        { th: "AI機能の導入", td: "従来のSaaSにはなかったAI機能を新たに追加し、ユーザーの業務を支援する新しい利用体験を設計しました。" },
        { th: "既存機能の改善", td: "旧製品で蓄積されたユーザーの要望や課題をもとに、既存機能の操作性や情報構成を見直し、より効率的に利用できるよう改善しました。" },
      ],
